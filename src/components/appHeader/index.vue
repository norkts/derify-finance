 ...
 * @LastEditors: kim
 * @LastEditTime: 2021-05-14 20:20:50
 * @FilePath: /derify-finance/src/components/appHeader/index.vue
-->
<template>
        ...
        <div class="nav">
          ...
          <div class="nav-main">
            ...
            <div class="nav-main-btn">
              <a href="https://derify.exchange" target="_blank">
